...
func (a *App) Run(ctx context.Context) error {
	...
	if a.collector == nil && a.pipeline == nil {
		<-ctx.Done()
		return nil
	}
	if a.collector == nil || a.pipeline == nil || a.publisher == nil {
		return fmt.Errorf("runtime components must be configured together")
	}
	...
	go func() { errors <- a.pipeline.Run(runCtx) }()
	go func() { errors <- a.collector.Start(runCtx, a.pipeline) }()
